...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        # dataset parameters
        # for train
        parser.add_argument('--data_root', type=str, default='/data_2/Deep3DFaceRecon_pytorch/datasets/CelebA/align/img_align_celeba/mask', help='dataset root')
        parser.add_argument('--flist', type=str, default='/data_2/Deep3DFaceRecon_pytorch/datasets/CelebA/train.txt', help='list of mask names of training set')
        parser.add_argument('--target_flist', type=str, default='/data_2/Deep3DFaceRecon_pytorch/datasets/CelebA/train_target.txt', help='list of mask names of training set')
        ...
        # for val
        parser.add_argument('--flist_val', type=str, default='/data_2/Deep3DFaceRecon_pytorch/datasets/CelebA/val.txt', help='list of mask names of val set')
