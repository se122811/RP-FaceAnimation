...
def main(rank, opt, name='uvll'):
    ...
    for i in range(len(im_path)):
        ...
        # model.save_mesh(os.path.join('/data_2/Deep3DFaceRecon_pytorch/uvll_img',img_name+'.obj')) # save reconstruction meshes
        # model.save_coeff(os.path.join('/data_2/Deep3DFaceRecon_pytorch/uvll_co', img_name+'.mat'))

        img = cv2.imread(im_path[i])
        model.uv_map_3ddfa(os.path.join('/data_2/Deep3DFaceRecon_pytorch/result_uv', img_name +'_texture.png'), img)

        # model.uv_map(os.path.join('/data_2/Deep3DFaceRecon_pytorch/result_uv', img_name +'.png'))
