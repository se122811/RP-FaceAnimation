...
from data.vox_video_dataset_cross import VoxVideoDataset
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        train_test_list = "/data/face/demo/Ours_concat_warp/epoch_213_iter_600000/cross_20_2/source_target_list_20_2.txt"
        with open(train_test_list , 'r') as f:
            for line in f.readlines():
            # for video_index in range(dataset.__len__()):
                source, target = line.strip().split()
                data = dataset.load_next_video(source, target)
                ...
                write2video("{}/{}".format("/data/face/demo/face_3D/cross_20/video", name), input_image, gt_images, warp_images, uv_map_input_list, rendering_images_syn, uv_map_output_list,rendering_images, gen_images )
