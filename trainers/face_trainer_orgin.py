...
class FaceTrainer(BaseTrainer):
    ...
    def optimize_parameters(self, data):
        ...
        vox_3dmm_img_source, vox_3dmm_img_target = data['img_3dmm_source'], data['img_3dmm_target']
        ...
        vox_3dmm_img = torch.cat((vox_3dmm_img_source, vox_3dmm_img_target))

        output_dict = self.net_G(input_image, vox_3dmm_img, input_semantic, self.training_stage)
    ...
    def _get_visualizations(self, data):
        ...
        with torch.no_grad():
            ...
            output_dict = self.net_G_ema(
                input_image, vox_3dmm_img, input_semantic, self.training_stage)
