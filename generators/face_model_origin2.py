...
class FaceGenerator(nn.Module):
    ...
    def forward(
        ...
        if stage == 'warp':
            ...
            #warping image에 rendering 해서 target이 되는 이미지로 만들기 
            rerender_output_vis = self.uvmap_to_render(refine_uv_map, output['warp_image'], self.pred_vertex, self.face_index, pred_mask)
