...
from data.vox_video_dataset_cross_demo import VoxVideoDataset
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        train_test_list = "/data/face/Deep3DFaceRecon_pytorch/datasets/friends/a/list"
        ...
        with open(train_test_list , 'r') as f:
            ...
            # for video_index in range(dataset.__len__()):
                ...
                target = line[:-1]
                data = dataset.load_next_video(target)
                ...
                for frame_index in range(len(data['target_semantics'])):
                    ...
                    # write2image("/data/face/demo/face_3D/cross_20/gen_images", name +"_{}".format(frame_index), output_dict['fake_image'])
                    # write2image("/data/face/demo/face_3D/cross_20/gt_images", name +"_{}".format(frame_index), data['target_image'][frame_index])
                    # write2image("/data/face/demo/face_3D/cross_20/uv_map_syn", name +"_{}".format(frame_index), output_dict['origin_uv_map'])
                    # write2image("/data/face/demo/face_3D/cross_20/uv_render_image_syn", name +"_{}".format(frame_index), output_dict['uv_render_img_syn'])
                    # write2image("/data/face/demo/face_3D/cross_20/uv_map", name +"_{}".format(frame_index),  output_dict['refine_uv_map'])
                    # write2image("/data/face/demo/face_3D/cross_20/uv_render_image", name +"_{}".format(frame_index), output_dict['uv_render_img'])
                    # write2image("/data/face/demo/face_3D/cross_20/warp_images", name +"_{}".format(frame_index), output_dict['warp_image'])
                    # write2image("/data/face/demo/face_3D/cross_20/source_images", name +"_{}".format(frame_index), input_source)
                    # write2image("/data/face/demo/face_3D/cross_20/face_render", name +"_{}".format(frame_index), output_dict['face_render'])
                ...
                write2video("{}/{}".format("/data/face/Deep3DFaceRecon_pytorch/datasets/friends/a/face_render/video1", name), input_image, gt_images, warp_images, uv_map_input_list, rendering_images_syn, uv_map_output_list,rendering_images, gen_images )
                write2video("{}/{}".format("/data/face/Deep3DFaceRecon_pytorch/datasets/friends/a/face_render/video2", name), input_image, gt_images, gen_images )
